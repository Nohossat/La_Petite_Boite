...
namespace Que_fait_le_Roi
{
    ...
    public partial class QueFaitLeRoi4Panel : QueFaitLeRoiClass
    {
        ...
        public QueFaitLeRoi4Panel(List<String> TextesBoutons, PrivateFontCollection pfc) : base(pfc)
        {
            initialize();
            chargementPartie();
            score = 0;
    ...
    public partial class QueFaitLeRoi8Panel : QueFaitLeRoiClass
    {
        ...
        public QueFaitLeRoi8Panel(List<String> TextesBoutons, PrivateFontCollection pfc) : base(pfc)
        {
            initialize();
            chargementPartie();
            score = 0;
    ...
    public partial class QueFaitLeRoi12Panel  : QueFaitLeRoiClass
    {
        ...
        public QueFaitLeRoi12Panel(List<String> TextesBoutons, PrivateFontCollection pfc) : base(pfc)
        {
            initialize();
            chargementPartie();
            score = 0;
